...
public class Solution {
    ...
    public static SortedMap<Integer, String> getReachedAchievements(TreeMap<Integer, String> map, Integer tasksCount) {
        ...
        SortedMap<Integer, String> newMap = new TreeMap<>(map.headMap(tasksCount));
        if(map.containsKey(tasksCount)){
            String value = map.get(tasksCount);
            newMap.put(tasksCount, value);
        }
